...
import type { FilterItem, FilterConfig } from './DataTableFilter';
...
export default function DataTable<T extends Record<string, unknown>>({
  ...
  const currentRowsPerPage =
    serverSide && externalRowsPerPage !== undefined ? externalRowsPerPage : internalRowsPerPage;
  const currentOrderBy = serverSide && externalSortBy !== undefined ? externalSortBy : orderBy;
  const currentOrder =
    serverSide && externalSortOrder !== undefined
      ? (externalSortOrder.toLowerCase() as Order)
      : order;
                        ...
                        <TableSortLabel
                          ...
                          sx={{
                            ...
                            '& .MuiTableSortLabel-icon': {
                              ...
                              opacity: currentOrderBy === column.id ? 1 : 0.6,
                            },
